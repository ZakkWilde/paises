sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ovly.paises.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ovly.paises.controller.ListSelector
			 */
			 ...
			 * @return {ovly.paises.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
